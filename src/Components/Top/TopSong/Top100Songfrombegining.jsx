...
function Top100Songfrombegining() {
    ...
    const sortedTracks = dataSpotify.sort((a, b) => b.ms_played - a.ms_played).slice(0, 100)
...
<div class="card" key={track._id.$oid}>
  <div class="top">
  <div class="pfp">
    <div class="playing">
  ...
  <div class="texts">
  <p class="title-1">{track.episode_show_name}</p>
  <p class="title-2">Time:{track.ms_played}</p>
  </div>
  </div>
